...
```ruby {3} title="config/environments/development.rb"
...
```javascript {3..30} title="webpack.config.js"
module.exports = {
  …
  module: {
    rules: [
...
```javascript {1} title="app/assets/javascripts/application.js"
...
```ruby {2..4} title="app/helpers/application_helper.rb"
...
```html {6..7} title="app/views/layouts/application.html.erb"
<!DOCTYPE html>
<html>
  <head>
...
```ruby {3..7} title="app/helpers/application_helper.rb"
module ApplicationHelper
  def webpack_asset_url(name)
...
```javascript {11,32..34} title="webpack.config.js"
module.exports = {
  …
  module: {
    rules: [
...
```javascript {3..5} title="webpack.config.js"
module.exports = {
  …
  plugins: [
...
```json title="public/assets/manifest.json"
{
...
```ruby {4,10..17} title="app/helpers/application_helper.rb"
module ApplicationHelper
  def webpack_asset_url(name)
    if Rails.env.production?
...
```html {7} title="app/views/layouts/application.html.erb"
<!DOCTYPE html>
<html>
  <head>
    <title>Webpacked</title>
